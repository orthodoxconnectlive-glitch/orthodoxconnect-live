    ...
    <div className="relative overflow-hidden rounded-3xl bg-(--bg-card) dark:bg-[#1c1611] border-2 border-(--ln-gold) dark:border-[#8b6b4a] p-5 shadow-xl mb-6">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div>
            <h2 className="text-lg md:text-xl font-serif-coptic font-bold text-(--tx-strong) dark:text-[#f5ebd9] flex items-center gap-2 uppercase tracking-wider">
              <span>⛪ {todayData.saintName}</span>
            </h2>
            <p className="text-xs text-(--tx-mute) dark:text-[#a89379] italic font-serif">
