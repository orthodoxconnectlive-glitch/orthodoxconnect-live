...
export const NotificationDropdown: React.FC<NotificationDropdownProps> = ({
  ...
  return (
    <>
      ...
      <div
        ref={dropdownRef}
        className="absolute right-0 top-12 w-80 sm:w-96 bg-[#fbf6ec] dark:bg-[#1a140e] border border-[#c5a059]/40 dark:border-[#8b6b4a]/60 rounded-2xl shadow-2xl z-50 overflow-hidden animate-fadeIn"
      >
        {/* Header */}
        <div className="p-4 border-b border-[#c5a059]/20 dark:border-[#8b6b4a]/30 bg-[#eddcb9]/60 dark:bg-[#282019] flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-serif font-bold text-sm text-[#3d2b18] dark:text-[#f5ebd9]">Notifications</h3>
            {unreadCount > 0 && (
