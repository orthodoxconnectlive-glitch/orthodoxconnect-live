    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-lg bg-stone-950 border border-amber-600/40 rounded-2xl p-6 shadow-2xl text-stone-100 text-left rtl:text-right">
        ...
        <h3 className="font-serif font-bold text-lg text-amber-100 mb-4 flex items-center gap-2">
          ...
          <span>{language === 'ar' ? 'إعادة مشاركة المنشور' : 'Reshare Post'}</span>
        </h3>
        ...
        <div className="flex rounded-xl bg-stone-900 p-1 mb-4 border border-amber-900/30">
          ...
          >
            ...
            <span>{language === 'ar' ? 'مشاركة فورية' : 'Instant Reshare'}</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span>{language === 'ar' ? 'اقتباس مع تعليق' : 'Quote Post'}</span>
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {kind === 'quote' && (
            <div>
              <textarea
                ...
                placeholder={
                  language === 'ar'
                    ? 'أضف تأملك الروحي أو تعليقك هنا...'
                    : 'Add your spiritual reflection or comment...'
                }
          ...
          <div className="p-3 rounded-xl bg-stone-900/80 border border-amber-900/30 text-xs space-y-1">
            ...
            <p className="text-stone-300 italic line-clamp-3 pl-8 rtl:pl-0 rtl:pr-8">"{post.text}"</p>
          </div>
